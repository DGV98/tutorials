...
fn addTen(x: *i32) void {
    _ = x; // TODO: remove this line and mutate through the pointer with .*
}
...
///
/// You'll need a temporary: read one value out (a const local), then write
/// through both pointers.
fn swap(a: *i32, b: *i32) void {
    // TODO: implement, then remove both discards below.
    _ = a;
    _ = b;
}
...
///
///   const items: []const i32 = arr;  // coercion, no copy
fn sumArray(arr: *const [4]i32) i32 {
    _ = arr; // TODO: remove; coerce to a slice, loop, and sum.
    return 0;
}
...
///   for (arr, 0..) |*slot, i| { ... }
///
/// (i is a usize; you'll need @intCast to store i * i into a u32.)
fn fillSquares(arr: *[5]u32) void {
    _ = arr; // TODO: remove and fill the array through the pointer.
}
